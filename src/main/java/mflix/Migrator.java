...
public class Migrator {
  ...
  public static void main(String[] args) {
    ...
    String mongoUri = "mongodb+srv://m220student:m220ClusterPassword@m220-cluster-0iqpy.mongodb.net/test?retryWrites=true&w=majority";
    ...
    // format pattern
    Bson queryFilter = type("lastupdated",BsonType.STRING);
    Bson projection = fields(include("lastupdated"));
    ...
    for (Document doc : movies.find(queryFilter).projection(projection)) {
    ...
    Bson ratingStringFilter = type("imdb.rating", BsonType.STRING);
    
    for (Document doc : movies.find(ratingStringFilter).projection(fields(include("imdb")))) {
